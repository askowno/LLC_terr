...
write.csv(lc7_rall, file = "lc7_rall.csv") # The csv is used in other workflows (consider using .rds format for within R sharing as it maintains tibble formatting) 
```
